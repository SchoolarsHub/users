...
class AcceptFriedshipRequestCommand:
    user_id: UUID
    sender_id: UUID
...
class AcceptFriendshipRequest:
    ...
    async def execute(self, command: AcceptFriedshipRequestCommand) -> None:
        ...
        await self.friendship_service.accept_friendship_request(sender_friendship=sender, receiver_friendship=receiver)
