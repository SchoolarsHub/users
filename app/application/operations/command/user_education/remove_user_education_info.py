...
class RemoveUserEducationInfoCommand:
    user_id: UUID
    education_id: UUID


class RemoveUserEducationInfo:
    def __init__(self, repository: UserRepository, unit_of_work: UnitOfWork, event_bus: EventBus) -> None:
        self.repository = repository
        self.unit_of_work = unit_of_work
        self.event_bus = event_bus

    async def execute(self, command: RemoveUserEducationInfoCommand) -> None:
        ...
        user.remove_education(command.education_id)
