...
class ChangeUserEducationDegreeCommand:
    user_id: UUID
    education_id: UUID
    degree: str


class ChangeUserEducationDegree:
    def __init__(self, repository: UserRepository, uow: UnitOfWork, event_bus: EventBus) -> None:
        self.repository = repository
        self.uow = uow
        self.event_bus = event_bus

    async def execute(self, command: ChangeUserEducationDegreeCommand) -> None:
        ...
        user.change_education_degree(command.education_id, command.degree)
