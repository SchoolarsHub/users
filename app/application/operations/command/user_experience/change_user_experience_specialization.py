...
class ChangeUserExperienceSpecializationCommand:
    user_id: UUID
    experience_info_is: UUID
    specialization: str


class ChangeUserExperienceSpecialization:
    def __init__(self, repository: UserRepository, unit_of_work: UnitOfWork, event_bus: EventBus) -> None:
        self.repository = repository
        self.unit_of_work = unit_of_work
        self.event_bus = event_bus

    async def execute(self, command: ChangeUserExperienceSpecializationCommand) -> None:
        ...
        user.change_experience_specialization(command.experience_info_id, command.specialization)
