...
class ChangeUserExperiencePeriodCommand:
    user_id: UUID
...
class ChangeUserExperiencePeriod:
    ...
    async def execute(self, command: ChangeUserExperiencePeriodCommand) -> None:
        ...
        user.change_experience_period(command.experience_info_id, command.start_working_date, command.finish_working_date)
